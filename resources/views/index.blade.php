...
<div class="hero-section">
    <div class="hero-content">
        ...
        <div class="hero-buttons">
            <a href="{{route('login')}}" class="shop-now">Koleksi Terbaru</a>
            <a href="#best-seller" class="view-more">Best Seller</a>
        </div>
    </div>
</div>
...
<div class="banner-section">
    <div class="banner-content">
        ...
        <a href="{{route('login')}}" class="banner-button">Lihat Koleksi</a>
    </div>
</div>
    ...
    <div class="category-grid">
        <div class="category-card">
            ...
            <div class="category-content">
                <h3>Liga Inggris</h3>
                <p>50+ Jersey</p>
                <a href="{{route('login')}}" class="category-button">Lihat Semua</a>
            </div>
        </div>
        <div class="category-card">
